...
15. `docs/04-ai-instructions/03-multi-agent-collaboration-rules.md`
...
- PR 자동 검증 기준은 `docs/workflow.md`와 `.github/workflows/ci.yml`을 동일 기준으로 유지하며, 패턴 기준까지 동일 문자열로 관리합니다.
