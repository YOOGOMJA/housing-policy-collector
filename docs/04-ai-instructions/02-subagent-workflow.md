...
## 6. 문서/PR 언어 및 충돌 처리
- 산출 문서와 PR 커뮤니케이션(제목/본문/리뷰 답변)은 한국어를 기본으로 사용합니다.
- 병합 충돌 발생 시 섹션 오너가 최종 승인하며, 충돌 해결 내역은 PR 본문에 반드시 기록합니다.
- 충돌 해결 후 `docs/README.md` 및 연관 문서 반영 누락을 다시 확인합니다.


## 7. Main 동기화 및 충돌 해소 실행 절차
- 작업 시작 전 메인라인 최신 커밋과 차이를 확인합니다.
